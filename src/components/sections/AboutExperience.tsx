  ...
  const cards = [
    {
      ...
      icon: <BookOpen className="text-secondary mb-4" size={32} />,
    ...
    },
    {
      ...
      icon: <Award className="text-highlight mb-4" size={32} />,
    ...
    },
    {
      title: "Creativity",
      subtitle: "Arts & Media",
      icon: <Palette className="text-accent mb-4" size={32} />,
    ...
    <section id="about" className="py-24 relative z-10">
      <div className="container mx-auto px-6">
        <SectionHeader 
          ...
          title={<>Where <span className="gradient-text">Potential</span> meets Opportunity</>}
